...
class Command(BaseCommand):
    ...
    def _seed_reviews(self):
        ...
        samples = [
            {'author_name': 'Alex Mercer', 'rating': 5, 'title': 'Absolute beast of a machine', 'content': 'Runs every game at max settings. The liquid cooling is whisper quiet.', 'is_approved': True},
            {'author_name': 'Sarah Connor', 'rating': 4, 'title': 'Worth every penny', 'content': 'Delivery was fast, setup was plug and play. Minor RGB software quirks.', 'is_approved': True},
            {'author_name': 'Neo Anderson', 'rating': 5, 'title': 'Best prebuilt I have owned', 'content': 'Premium build quality throughout. Cable management is flawless.', 'is_approved': False},
        ]
        for data in samples:
