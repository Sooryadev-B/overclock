...
Static files (CSS theme) are also loaded from `pcshop/static/`.# Overclock
...
5. **Register a test customer** at http://127.0.0.1:8000/accounts/register/ to test the user-facing account flow.# Overclock
